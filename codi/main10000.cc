...
int main() {
    ...
    tactTsha256tres = 0;
    ifstream myfile;
    myfile.open ("claus/inp_10000pw.txt");
...
double trues = 0;
    ...
    cout << "RESULTATS DEL HASH FH1 EN UN DOCUMENT DE 10000 CLAUS: " << endl;
    ...
    cout << "RESULTATS DEL SHA256 EN UN DOCUMENT DE 10000 CLAUS: " << endl;
