...
string to_sha256(string argv)
{
	string message = "";
	bool testing = 0;
    
    //cout << "Using " << argv << " as mesage\n";
    message = argv; 
...
string compute_hash(const vector<unsigned long> block)
{
	...
	unsigned long static H0 = 0;
	unsigned long static H1 = 0;
	unsigned long static H2 = 0;
	unsigned long static H3 = 0;
	unsigned long static H4 = 0;
	unsigned long static H5 = 0;
	unsigned long static H6 = 0;
	unsigned long static H7 = 0;
